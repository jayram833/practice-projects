...
function Search() {
    ...
    return (
        <div className="flex justify-center mt-5 flex-col items-center">
            ...
            <div>
                <ul className="max-h-[500px] overflow-x-scroll">
...
function Item({ item }: ItemProps) {
    return <li className="bg-blue-600 text-white cursor-pointer hover:bg-blue-500 w-110 px-2 py-1 border-b-[0.5px] border-blue-100">{item.name}</li>
}
