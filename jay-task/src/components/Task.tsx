...
const Task = memo(function ({ task: { title, status, priority, category, id }, isOpen, onToggleActions, onDeleteTask }) {
            ...
            <td>
                ...
                {isOpen && (
                    <div className="flex flex-col items-start mt-1 dark:bg-slate-950 border-[0.5px] z-50 bg-white rounded-sm absolute">
                        ...
                        <button className="cursor-pointer dark:hover:bg-slate-800 w-full border-gray-500 px-5 py-1 rounded-md  hover:bg-slate-100">
                            Edit
                        </button>
                    </div>
                )}
